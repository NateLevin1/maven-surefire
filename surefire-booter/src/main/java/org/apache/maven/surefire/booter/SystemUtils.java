...
public final class SystemUtils
{
    ...
    /**
     * If {@code jvmExecutable} is <code>/jdk/bin/java</code> (since jdk9) or <code>/jdk/jre/bin/java</code> (prior to jdk9)
     * then the absolute path to JDK home is returned <code>/jdk</code>.
     * <br>
    ...
    /**
     * If system property <code>java.home</code> is <code>/jdk</code> (since jdk9) or <code>/jdk/jre</code> (prior to jdk9) then
